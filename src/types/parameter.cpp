...
namespace proslam {
  ...
  //ds Command Line
    ...
    std::string Parameter::filename_configuration  = "";
  ...
  //MotionEstimation
    ...
    int32_t Parameter::MotionEstimation::maximum_distance_tracking_pixels           = 150*150; //ds maximum allowed pixel distance between image coordinates prediction and actual detection

    //ds framepoint track recovery
    int32_t Parameter::MotionEstimation::maximum_number_of_landmark_recoveries = 3;
